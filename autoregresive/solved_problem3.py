...
#data = synthetic_data_generator_v3(seq_len=seq_len, window_len=window_len, inc=inc)
data = SynthSinusGenerator.synthetic_data_generator_v4(Tools.sinus_generator,
                                                       seq_len=seq_len,
                                                       window_len=window_len, inc=inc)
X_data = data[0]
y_data = data[1]
